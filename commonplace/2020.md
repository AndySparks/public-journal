...
- [LifeForward: Charting the Journey Ahead](https://www.amazon.com/LifeForward-Charting-Pamela-D-McLean/dp/1884433766)
...
- Began using [Fantastical](https://flexibits.com/fantastical) for my calendar (all calendars are google calendars). It's great because it allows me to switch time zones, has better visual display, and functions well with mobile. (October).
